...
# NEUE IDs FÜR WELCOME UND RULES
...
async def send_rules(interaction: discord.Interaction):
    ...
    await interaction.response.send_message("Regelwerk erfolgreich gepostet!", ephemeral=True)
...
async def test_welcome(interaction: discord.Interaction):
    ...
    await interaction.response.send_message("Simuliere Server-Beitritt... Schau im Welcome-Kanal nach!", ephemeral=True)
...
async def on_ready():
    ...
    try:
        print("Starte aggressiven Sync der Slash-Commands...")
        bot.tree.copy_global_to(guild=discord.Object(id=GUILD_ID))
        synced = await bot.tree.sync(guild=discord.Object(id=GUILD_ID))
